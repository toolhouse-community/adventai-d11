# Hello AdventAI - Day 1️⃣1️⃣

![Banner](repository-assets/banner.png)

[![Fork](https://img.shields.io/badge/CLONE%20THIS%20REPO-0088FF?style=for-the-badge)](https://github.com/new?template_owner=toolhouse-community&template_name=adventai-d11&owner=%40me&name=th-adventai-d11&description=AdventAI+Day+11+Fork&visibility=public)

## Table of Contents

- [Hello AdventAI - Day 1️⃣1️⃣](#hello-adventai---day-1️⃣1️⃣)
...
![Screengrab](repository-assets/wwed_screen.gif)

On Day ️1️⃣1️⃣, we are unwrapping What Would Elon Do, which rummages through Elon's X account to get you advice from the world's richest man! Of course, we send you updates via E-mail if Elon's thoughts change!

What the app does:

- **Good Advice, Elon Style**: Mr. Musk has his own way with things, and regularly shares his thoughts on X. We use the `search_x` tool to grab similar tweets to your questions and let AI help you with advice.
- **Email Notifications**: Delivers emails with advice on topics of your preferences.

> [!NOTE]
> This app requires the `send_email`, `memory_fetch`, `memory_store`, `memory_delete` and `search_x` tools.
...
- [![Fork](https://img.shields.io/badge/CLONE%20THIS%20REPO-0088FF?style=for-the-badge)](https://github.com/new?template_owner=toolhouse-community&template_name=adventai-d11&owner=%40me&name=th-adventai-d11&description=AdventAI+Day+11+Fork&visibility=public)
  ...
  Or Create a [Fork](https://github.com/new?template_owner=toolhouse-community&template_name=adventai-d11&owner=%40me&name=th-project&description=AdventAI+Day+11+Fork&visibility=public)
...
```bash
git clone https://github.com/{USERNAME}/adventai-d11/
cd adventai-d11
```
...
[Back to Top ⬆️](#hello-adventai---day-1️⃣1️⃣)
